"""Local ETAK building search API for Eesti RenoHeat Explorer.

Run:
    py -3 backend/etak_search_server.py --csv C:\Users\mowani\Downloads\etak_buildings_index.csv
        ...
        def do_GET(self) -> None:  # noqa: N802
            ...
            try:
                ...
                if parsed.path == "/api/search":
                    ...
                    self._send_json(200, {"query": query, "count": len(index.search(query, limit)), "results": index.search(query, limit)})
                    return
